...
<table border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
	  ...
	  <td width="100" align="center" bgcolor="#FFFFFF" rowspan="3">Gerar PDF</td>
...
<Br>
<em>Este é um software livre, portanto não necessita de uma licença de uso.</em><br />
  <br>
...
<table border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
      <td width="10" height="10" bgcolor="#FFFFFF"></td>
	  <td width="100" align="center" bgcolor="#FFFFFF" rowspan="3">Visualizar PDF</td>
      <td width="470" bgcolor="#FFFFFF"></td>
	</tr>
	<tr>
	  <td height="1" bgcolor="#CCCCCC"></td>
...
<table border="0" align="center" cellpadding="0" cellspacing="1">
    <tr>
      <td width="10" height="10" bgcolor="#FFFFFF"></td>
	  <td width="100" align="center" bgcolor="#FFFFFF" rowspan="3">Browser</td>
      <td width="470" bgcolor="#FFFFFF"></td>
	</tr>
	<tr>
	  <td height="1" bgcolor="#CCCCCC"></td>
