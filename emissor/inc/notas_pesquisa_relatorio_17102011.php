...
?>
<br />
 <form method="post" id="frmRelatorio"  target="_blank" action="inc/notas_relatorio_resultado.php" onsubmit="if(document.getElementById('cmbAno').value == '' || document.getElementById('cmbAnoFim').value == '' || document.getElementById('cmbMes').value == '' || document.getElementById('cmbMesFim').value == '0'){ alert('escolha o periodo'); return false; }">
