...
//GERA O CÓDIGO DE VERIFICAÃ‡ÃƒO
...
<form name="frmInserir" method="post" action="notas.php" id="frmInserir">
...
<table width="100%" border="0" cellspacing="2" cellpadding="2"> 
  ...
  <tr>
    ...
    <td align="left"><input name="txtTomadorCNPJ" type="text" size="20" class="texto" onkeydown="stopMsk( event );return NumbersOnly( event );" onkeyup="CNPJCPFMsk( this );"  maxlength="18" id="txtTomadorCNPJ" 
    onblur="acessoAjax('inc/tomador_nota.ajax.php','frmInserir','divContainer',true);acessoAjax('inc/valida_cpf.ajax.php','frmInserir','divCPFValidar',true)">
...
<tr>
  ...
  <tr>
    ...
    <td align="left">
	 <input name="txtTomadorCEP" id="txtTomadorCEP" type="text" size="15" onblur="buscacep();" class="texto" onkeydown="return NumbersOnly( event );" maxlength="9" onkeyup="MaskCEP(this);" >
	</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="left"><input name="txtTomadorLogradouro" id="txtTomadorLogradouro" type="text" size="30" class="texto">
     &nbsp;&nbsp;N&uacute;mero 
     <input name="txtTomadorNumero" type="text" onkeydown="return NumbersOnly( event );"  size="5" class="texto" maxlength="5"  />
	</td>
  </tr>  
  <tr>
    ...
    <td align="left">
        <div  id="divTomadorMunicipio">
            <select name="txtTomadorMunicipio" id="txtTomadorMunicipio" class="combo">
                <?php
                    $sql_municipio = mysql_query("SELECT nome FROM municipios WHERE uf = '$uf_busca' order by nome");
...
<table width="100%" border="0" cellspacing="2" cellpadding="2">
  <tr>
      <td align="center"><strong>Discrimina&ccedil;&atilde;o dos Servi&ccedil;os e/ou Dedu&ccedil;&otilde;es</strong></td>
  </tr>
  <tr>
   <td align="center">
