  ...
  <tr id="camposservico<?php echo $contservico; ?>" style="display:none">	    
    <td align="left" >
	 ...
	 {?>
		 ...
		 <?php
			$sql_servicos = mysql_query("SELECT codigo, codservico, descricao, aliquota, estado FROM servicos WHERE estado = 'A' AND codcategoria='$codcategoria' ORDER BY codservico"); 
		 ?>
