...
if (typeof obj == "string") {
  if (null == (obj = document.getElementById(obj))) {
   throw new Error(utf8_decode("Elemento HTML não encontrado. Não foi possível adicionar o evento."));
  }
}
if (obj.attachEvent) {
  ...
  throw new Error(utf8_decode("Seu browser não suporta adição de eventos."));
}
}
