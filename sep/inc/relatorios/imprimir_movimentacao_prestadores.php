        ...
        <table width="95%" border="2" cellspacing="0" class="tabela">
          <tr>
            ...
            <td width="584" height="33" colspan="2">
              <span class="style1">
                  <center>
                     <p>RELAT&Oacute;RIO DE MOVIMENTA&Ccedil;&Atilde;O POR PRESTADORES </p>
            ...
            ?>
                <table width="95%" class="tabela" border="1" cellspacing="0">
                    <tr style="background-color:#999999">
                      <td width="50%" align="center"><strong>Prestador</strong></td>
                      <td width="15%" align="center"><strong>CNPJ / CPF</strong></td>
                      <td width="15%" align="center"><strong>Valor Arrecadado</strong></td>
                      <td width="10%" align="center"><strong>ISS</strong></td>
