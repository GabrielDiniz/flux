...
<table border="0" cellspacing="0" cellpadding="0" >
  <tr>
    ...
    <td width="700" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Relat&oacute;rios - Al&iacute;quotas do Simples </td>
...
<form id="frmIssqnRetido" method="post" target="_blank" action="inc/relatorios/imprimir_aliquota_simples.php">
<fieldset>
<legend><strong>Pesquisa de Al&iacute;quotas do Simples utilizada pelo contribuinte</strong></legend>
