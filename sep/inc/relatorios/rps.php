...
<tr>
	...
	<td width="700" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Relat&oacute;rios - Opera&ccedil;&otilde;es Efetuadas </td>
...
<tr>
    ...
    <td align="center">
		<form id="frmOperacaoes" name="frmOperacaoes" method="post" target="_blank" action="inc/relatorios/imprimirRPS.php">
		<fieldset>
		<legend>
			<strong>RPS convertidos em Nota Fiscal</strong>
		</legend>
		<table align="left" width="100%">
			<tr>
				...
				<td>
					<label><input type="radio" name="rdbRPS" value="dentro" checked>Dentro do Prazo legal</label>&nbsp;
					<label><input type="radio" name="rdbRPS" value="fora" >Fora do prazo legal</label>&nbsp;
			    </td>
			</tr>
            <tr>
				<td>
