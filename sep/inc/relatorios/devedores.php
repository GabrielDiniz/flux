...
<tr>
    ...
    <td align="center">
		<form id="frmDevedores" name="frmDevedores" method="post" target="_blank" action="inc/relatorios/imprimirDevedores.php">
		<fieldset>
		<legend>
			<strong>Maiores Devedores</strong>
		</legend>
		<table align="left" width="100%">
			<tr>
				...
				<td>
					<label><input type="radio" name="rdbMaioresP" value="codnota" checked >Notas Emitidas </label>&nbsp;
					<label><input type="radio" name="rdbMaioresP" value="codlivro" >Livros</label>
			  </td>
			</tr>
