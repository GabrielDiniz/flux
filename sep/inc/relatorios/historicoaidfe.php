...
<tr>
	...
	<td width="700" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Relat&oacute;rios - AIDFe </td>
...
<tr>
    ...
    <td align="center">
		<form id="frmAidfe" name="frmAidfe" method="post" target="_blank" action="inc/relatorios/imprimirAidfe.php">
		<fieldset>
		<legend>
			<strong>AIDFe</strong>
		</legend>
		<table align="left" width="100%">
			<tr>
				...
				<td>
					<label><input type="radio" name="rdbAidfe" value="historico" checked>Hist&oacute;rico</label>&nbsp;
			    </td>
			</tr>
       	</table>
    	</fieldset>
