...
<div id="divBusca"  >
	<?php include("inc/relatorios/busca_simples_nacional.php"); ?>
</div>
<?php 
...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">
  <tr>
    ...
    <td width="700" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Relat&oacute;rios - Simples Nacional</td>
...
<form id="frmMovimentacao" method="post" target="_blank" action="inc/relatorios/imprimir_simples_nacional.php">
<fieldset>
<legend><strong>Pesquisa de Simples Nacional</strong></legend>
