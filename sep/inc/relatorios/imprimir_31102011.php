...
<body>
    <div class="pagina">
        ...
        <table width="95%" border="1" cellspacing="0" class="tabelameio">
                ...
                <td width="32%" >
                    <table>
                        ...
                        <tr>
							...
							<td>
								<?php echo "<font class=\"fonte\"> $qtdtotal<font>"; ?>
							</td>
                        </tr>
					</table>
			...
			<?php
				//Se cmbMaioresP != selecione
				if(!$_POST['cmbMaioresP'] == 'SELECIONE'){
					//Se cmbMaioresP = notas emitidas
					if($_POST['cmbMaioresP'] == 'NE'){
						$query = ("
							SELECT
							...
							GROUP BY codemissor
							ORDER BY totalnotasemitidas DESC
						");
					//Se cmbMaioresP = valor arrecadado
					}else if($_POST['cmbMaioresP'] == 'VA'){
						$query = ("
							SELECT
								cadastro.razaosocial,
								cadastro.cnpj,
								...
								cadastro.estado,
								notas.codemissor,
								SUM(basecalculo) as totalvalorarrecadado
							FROM cadastro
							INNER JOIN notas ON cadastro.codigo = notas.codemissor
							GROUP BY codemissor
