...
?>
    ...
    ?>
        ...
        <title>Imprimir Movimenta&ccedil;&atilde;o geral</title>
        ...
        <table width="95%" border="2" cellspacing="0" class="tabela">
          <tr>
            ...
            <td width="584" height="33" colspan="2">
              <span class="style1">
                  <center>
                     <p>RELAT&Oacute;RIO DE MOVIMENTA&Ccedil;&Atilde;O GERAL </p>
        ...
        <?php
         ...
         ?>
            <tr id="trDecc<?php echo $x;?>">
                ...
                <td bgcolor="white" align="center"><?php echo $dados_pesquisa['tipo'];?></td>
