  ...
  <tr id="campossocio<?php echo $cont; ?>" style="display:<?php echo $display; ?>; width:500px;">
      <td align="left" >
          <table>
              ...
              <tr>
                  <td>
                      <input type="text" size="40" maxlength="100" name="txtNomeSocio<?php echo $cont; ?>" id="txtNomeSocio<?php echo $cont; ?>" class="texto" /><?php echo $obrigatorio; ?>
                  </td>
                  <td>
                      <input type="text" size="14" maxlength="14" name="txtCpfSocio<?php echo $cont; ?>" id="txtCpfSocio<?php echo $cont; ?>" class="texto" onkeyup="CNPJCPFMsk( this );"/><?php echo $obrigatorio; ?>
                  </td>
                  <td>
                      <?php
                        if($cont!=1){
