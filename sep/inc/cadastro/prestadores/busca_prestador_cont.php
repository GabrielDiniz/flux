...
<table border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC">
	...
	<tr>
	  ...
	  <tr>
		...
		<select name="CODPRESTADOR" id="CODPRESTADOR" size="18" style="width:400px; background-color:#255b8f;color:#FFFFFF;" class="combo" onchange="document.getElementById('frmbuscaprest').submit();">
			<?php 
