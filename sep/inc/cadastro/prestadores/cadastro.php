...
//Verifica se foi inserido alguma empresa nova, se for vai para o arquivo de inserï¿½ï¿½o
...
<!-- Formulï¿½rio de inserï¿½ï¿½o de empresa  -->
<style type="text/css">
<!--
#divBusca {
	position:absolute;
...
<?php	
	if(($_POST['CODEMISSOR'])){		   
		...
		//Busca as informaï¿½ï¿½es que sï¿½o extra para cada tipo de prestador
...
<table border="0" cellspacing="0" cellpadding="0" class="form">
	...
	<form  method="post" name="frmCadastroEmpresa" id="frmCadastroEmpresa">
		...
		<table border="0" align="center" id="tblEmpresa">
			...
			<tr>
				<td colspan="4">
					...
					<!-- Tabela instituiï¿½ï¿½o e operadoras -->
		...
		<table id="bigtable" width="100%">
			...
			<tr>
				<td colspan="4" align="left">
					<!-- botï¿½o que chama a funï¿½ï¿½o JS e mostra + um sï¿½cio-->
			...
			<tr id="trBotao">
				<td colspan="4" align="left">
					<!-- botï¿½o que chama a funï¿½ï¿½o JS e mostra + um serviï¿½o-->
...
<!-- Formulï¿½rio de inserï¿½ï¿½o de serviï¿½os Fim-->
<script>
