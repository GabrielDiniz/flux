...
?>
 <table border="0" cellspacing="0" cellpadding="0" >
	...
	<tr>
		...
		<td align="center">
			<form method="post"  name="frmbuscaprest" id="frmbuscaprest">
				<input type="hidden" name="include" id="include" value="<?php echo  $_POST['include'];?>" />
				<table width="100%">
                    <tr>
                        <td>
                            C&oacute;digo do Cadastro
                        </td>
                        <td rowspan="4" valign="middle"><input name="btBuscarPrestador" type="submit" value="" id="btBuscarCliente" title="Buscar"></td>
                    </tr>
                    <tr>
                        <td>
                            <input type="text" name="txtBuscaCodCadastro" class="texto" size="39" style="background-color:#255b8f; color:#FFFFFF; text-transform:uppercase" />
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
					...
					<tr>
						<td  align="center">
							<select name="CODPRESTADOR" id="CODPRESTADOR" size="13" style="width:277px; background-color:#255b8f;color:#FFFFFF;" class="combo" 
							onchange="document.getElementById('frmbuscaprest').submit();">
								<?php 
...
<map name="Map">
	<area shape="rect" coords="277,4,294,18" onclick="document.getElementById('frmbuscaprest').style.visibility='hidden';" title="Fechar">
</map>
