...
$include=$_POST['include'];
	...
	if(mysql_num_rows($teste_nome)>0){
	   ...
	   if($codtipo == $codtipo_inst){
			...
			add_logs('Inseriu uma Institui&ccedil;&atilde;o Financeira');
			...
			$codcargo = codcargo("Gerente");
			add_logs('Inseriu uma Operadora de Cr&eacute;dito');
			mysql_query("INSERT cadastro_resp SET nome = '$gerente', cpf = '$gerente_cpf', codcargo = '$codcargo', codemissor = '$codigoempresa'");
		...
		5- Sua senha &eacute; <b><font color=\"RED\">$senha</font></b><br>
		6- Insira o c&oacute;digo de verifica&ccedil;&atilde;o que aparece ao lado<br>
		7- Depois de ter acessado o sistema, v&aacute; no link <b>Cadastro</b> e troque sua senha<br>";
