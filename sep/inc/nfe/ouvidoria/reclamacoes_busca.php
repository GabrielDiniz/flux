...
<form name="frmListaReclamacoesPendentes" method="post" id="frmListaReclamacoesPendentes" >
  ...
  ?>
    <tr bgcolor="#FFFFFF">
      ...
      <td align="center"><?php echo dataPt($datareclamacao); ?></td>
      <td align="center"><?php echo $responsavel; ?></td>
      <td align="center"><a style="cursor:pointer" onclick="document.getElementById('btEditar').value='R';document.getElementById('CODIGOlista').value='<?php echo $codigo;?>';document.getElementById('frmListaReclamacoesPendentes').submit();" ><input type="button" class="botao" value="Editar" /></a></td>
    </tr>
	<?php
	} // fecha while
	?>
...
<form name="frmListaReclamacoesAtendidas" method="post" id="frmListaReclamacoesAtendidas">
  ...
  ?>
    <tr bgcolor="#FFFFFF">
      <td align="center"><?php echo $especificacao; ?></td>
      <td align="center"><?php echo $tomador_cnpj; ?></td>
      <td align="center"><?php echo dataPt($dataatendimento); ?></td>
      <td align="center"><?php echo $responsavel; ?></td>
      <td align="center"><a style="cursor:pointer" onclick="document.getElementById('btEditar').value='R';document.getElementById('CODIGObusca').value='<?php echo $codigo;?>';document.getElementById('frmListaReclamacoesAtendidas').submit();" ><input type="button" class="botao" value="Editar" /></a></td>
    </tr>
	<?php
	} // fecha while
	?>
