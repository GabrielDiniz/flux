...
$sqlpago = ("SELECT guias_declaracoes.relacionamento, guia_pagamento.codigo FROM guia_pagamento INNER JOIN guias_declaracoes ON guia_pagamento.codigo=guias_declaracoes.codguia WHERE guia_pagamento.pago = 'N' GROUP BY guia_pagamento.codigo ORDER BY guias_declaracoes.relacionamento");
?>
