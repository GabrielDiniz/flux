...
<tr>
    ...
    <td align="center">
		<form id="frmRelatorios" method="post" target="_blank" action="inc/relatorios/imprimirPrestadores.php">
		<fieldset>
		<legend>
			<strong>Maiores Prestadores de Servi&ccedil;os</strong>
		</legend>
		<table align="left" width="100">
			...
			<tr>
				...
				<td>
					<select name="cmbMaioresP" id="cmbMaioresP">
						<option value="SELECIONE">Selecione!</option>
						<option value="NE">Notas Emitidas</option>
						<option value="VA">Valor Arrecadado</option>
					</select>
				</td>
			</tr>
			<tr>
