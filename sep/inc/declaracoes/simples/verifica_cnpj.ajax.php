...
?>
<fieldset>
<form method="post" name="frmDec" id="frmDec">
	<input type="hidden" name="include" id="include" value="<?php echo $_GET['include'];?>" />
	<input type="hidden" name="hdCnpjSimples" value="<?php echo $cnpj; ?>" />
	<input type="hidden" name="hdCodSimples" value="<?php echo $codigo; ?>" />
	<table width="100%" height="100%"  border="0" align="center" cellpadding="5" cellspacing="0">
		...
		<tr>
			...
			<td width="75%" align="left">
				<input name="btOk" type="submit" value="Verificar" class="botao" onclick="contaTeclas('txtCNPJ','prestador','divInfos','Simples Nacional'); return false;" />
			</td>
		</tr>
		<tr>
