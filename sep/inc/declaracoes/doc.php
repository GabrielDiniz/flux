...
<script language="javascript">
	function docVisualizarContas(coddoc){
	...
	function btBuscar_click(codemissor,retorno){
		if(ValidaFormulario('_mes|_ano','Por favor selecione um mês e um ano!')){
			...
			ajax({
				url:'inc/declaracoes/doc/guias/guia_pagamento_lista.ajax.php?codemissor='+codigo_emissor+'&cmbAno='+ano+'&cmbMes='+mes+'&a=a',
				espera: function(){
...
<table border="0" cellspacing="0" cellpadding="0" class="form">
  ...
  <tr>
    ...
    <td align="center">
		<div id="divDoc">
        <form name="frmOperadoras" id="frmOperadoras" method="post" onsubmit="return false">
