...
<?php
	if($_POST['btDeclarar'] == "Declarar"){
		include("inc/declaracoes/dec/declarar_sql.php");
	}
	if($_POST["btBoleto"] == "Gerar Boleto"){
		include("inc/declaracoes/dec/guias/gerar_boleto.php");
	}
?>
<script>
	function btBuscar_click(codemissor,retorno){
		if(ValidaFormulario('_mes|_ano','Por favor selecione um mês e um ano!')){
			...
			ajax({
				url:'inc/declaracoes/dec/guias/guia_pagamento_lista.ajax.php?codemissor='+codigo_emissor+'&cmbAno='+ano+'&cmbMes='+mes+'&a=a',
				espera: function(){
...
<table border="0" cellspacing="0" cellpadding="0" class="form">
	<tr>
		...
		<td width="650" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Declara&ccedil;&otilde;es de Cartórios<br />
		</td>
	...
	<tr>
		...
		<td align="center">
		<div id="divDec">
			<form name="frmDec" id="frmCartorios" method="post" onsubmit="return false">
				...
				<table width="100%">
					...
					<tr>
						<td align="left" colspan="2">
                            ...
                            onclick="acessoAjax('inc/declaracoes/dec/declarar_pesquisa.ajax.php','frmCartorios','divDeclaracoesCartorios')" />
							<input name="btNova" type="submit" class="botao" value="Nova declaração" 
                            onclick="acessoAjax('inc/declaracoes/dec/verifica_cnpj.ajax.php','frmCartorios','divDec')" />
							<input name="btGuia" value="Guias" type="submit" class="botao"
                            onclick="acessoAjax('inc/declaracoes/dec/guias/verifica_cnpj_guias.ajax.php','frmCartorios','divDec')" />
							&nbsp;
							<input name="btLimpar" type="reset" class="botao" value="Limpar" />
						</td>
					</tr>
				</table>
				<div id="divDeclaracoesCartorios"></div>
				</fieldset>
			</form>
			</div>
		</td>
