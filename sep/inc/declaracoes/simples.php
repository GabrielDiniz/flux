...
<?php
	if($_POST['btDeclarar'] == "Declarar"){
		include("inc/declaracoes/simples/geraguia.php");
	}
?>
<table border="0" cellspacing="0" cellpadding="0" class="form">
  <tr>
    <td width="18" align="left" background="img/form/cabecalho_fundo.jpg"><img src="img/form/cabecalho_icone.jpg" /></td>
    <td width="650" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Declaração Simples<br /></td>  
                ...
                <table width="100%">
                    ...
                    <tr>
                    	<td align="left" colspan="2">
                    		...
                    		onclick="acessoAjax('inc/declaracoes/simples/verifica_cnpj.ajax.php','frmDes','divSimples')" />
                            &nbsp;
