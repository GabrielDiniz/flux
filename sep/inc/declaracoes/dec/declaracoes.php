...
<table border="0" cellspacing="0" cellpadding="0" class="form">
  <tr>
    ...
    <td width="650" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Declra&ccedil;&otilde;es de Cartórios<br /></td>  
    <td width="19" align="right" valign="top" background="img/form/cabecalho_fundo.jpg"><a href=""><img src="img/form/cabecalho_btfechar.jpg" width="19" height="21" border="0" /></a></td>
  </tr>
  <tr>
    <td width="18" background="img/form/lateralesq.jpg"></td>
    <td align="center">
        <form name="frmDecc" id="frmCartorios" method="post" onsubmit="return false">
                ...
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td align="left">
                            ...
                            <select name="cmbAno" class="combo">
                            	<option value=""></option>
                                <?php
								$sql_ano = mysql_query("SELECT SUBSTRING(competencia,1,4) FROM cartorios_des GROUP BY SUBSTRING(competencia,1,4) ORDER BY SUBSTRING(competencia,1,4) DESC");
                    ...
                    <tr>
                    	<td align="left" colspan="2">
                            ...
                            onclick="acessoAjax('inc/cartorios/declarar_pesquisa.ajax.php','frmCartorios','divDeclaracoesCartorios')" />
                            &nbsp;
