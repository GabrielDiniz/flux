...
<table border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <td align="center">
<form method="post"  name="frmBuscaCart" id="frmBuscaCart">
		<input type="hidden" name="include" id="include" value="<?php echo  $_POST['include'];?>" />
	<table width="100%">
		<tr>
			<td><input name="txtBuscaNomeCart" id="txtBuscaNomeCart" type="text" class="texto" size="39" style="background-color:#255b8f; color:#FFFFFF; text-transform:uppercase"  >	
				<input name="btBuscarCliente" type="submit" value="" id="btBuscarCliente"></td>
	  	</tr>
	  <tr>
		<td background="img/busca_fundo.jpg" align="center">	
		<select name="CODCART" id="CODCART" size="13" style="width:277px; background-color:#255b8f;color:#FFFFFF;" class="combo" onchange="document.frmBuscaCart.submit();">   		
			<?php						
				if(isset($_POST['txtBuscaNomeCart']))
					{
...
<map name="Map"><area shape="rect" coords="277,4,294,18" onclick="document.getElementById('divBuscaCart').style.visibility='hidden';" alt="Fechar">
</map>