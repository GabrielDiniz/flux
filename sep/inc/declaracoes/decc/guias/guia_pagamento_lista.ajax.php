...
$sql = mysql_query("
	...
	FROM 
		decc_des
	INNER JOIN 
		decc_des_notas ON decc_des.codigo = decc_des_notas.coddecc_des
	WHERE 
		MONTH(decc_des.competencia) = '$mes' AND 
		YEAR(decc_des.competencia) = '$ano' AND 
		decc_des.codempreiteira = '$codemissor' AND 
		decc_des.estado = 'N'
	GROUP BY 
		decc_des.codigo
");
