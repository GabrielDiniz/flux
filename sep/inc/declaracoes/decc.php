...
<script>
	function btBuscar_click(codemissor,retorno){
		if(ValidaFormulario('_mes|_ano','Por favor selecione um mês e um ano!')){
			...
			ajax({
				url:'inc/declaracoes/decc/guias/guia_pagamento_lista.ajax.php?codemissor='+codigo_emissor+'&cmbAno='+ano+'&cmbMes='+mes+'&a=a',
				espera: function(){
...
<?php
	if($_POST['btDeclarar'] == "Declarar"){
		include("inc/declaracoes/decc/declarar_sql.php");
	}
	if($_POST["btBoleto"] == "Gerar Boleto"){
		include("inc/declaracoes/decc/guias/gerar_boleto.php");
	}
?>
<table border="0" cellspacing="0" cellpadding="0" class="form">
  <tr>
    <td width="18" align="left" background="img/form/cabecalho_fundo.jpg"><img src="img/form/cabecalho_icone.jpg" /></td>
    <td width="650" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Declara&ccedil;&otilde;es de Empreiteiras<br /></td>  
                ...
                <table width="100%">
                    ...
                    <tr>
                    	<td align="left" colspan="2">
                            ...
                            onclick="acessoAjax('inc/declaracoes/decc/declarar_pesquisa.ajax.php','frmEmpreiteiras','divDeclaracoesEmpreiteiras')" />
							<input name="btNova" type="submit" class="botao" value="Nova declaração" 
                            onclick="acessoAjax('inc/declaracoes/decc/verifica_cnpj.ajax.php','frmEmpreiteiras','divDecc')" />
							<input name="btGuia" value="Guias" type="submit" class="botao"
                            onclick="acessoAjax('inc/declaracoes/decc/guias/verifica_cnpj_guias.ajax.php','frmEmpreiteiras','divDecc')" />
                            &nbsp;
