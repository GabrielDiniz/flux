...
<?php
	...
	$query = ("SELECT codigo,
						   ...
						   SUBSTRING(competencia, 1, 7),
						   codverificacao
						   FROM decc_des
						   WHERE codempreiteira = '$codempreiteira'
...
?>
            ...
            <?php
                ...
                <tr bgcolor="#FFFFFF">
                    ...
                    <td align="center">
                        ...
                        acessoAjax('inc/empreiteiras/auditar.php','frmAuditoria','divauditoria')">
                    </td>
                </tr>
                <?php
                }//fim while
        ...
        <?php
                ...
                echo "
                    <tr>
                        <td align=\"center\"><b>Não há declarações de Empreiteiras</b></td>
                    </tr>
                ";
            }//fim if
