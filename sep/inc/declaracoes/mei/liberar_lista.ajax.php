...
?>
	<table width="100%">
		...
		<tr bgcolor="#FFFFFF">
			...
			<td width="174" align="center" colspan=""><?php echo $cnpj;?></td>
<td align="center">
				<input name="btLiberar" type="button" value="Ativar" class="botao" onClick="document.getElementById('hdCodSolicitacao').value=<?php echo $codigo;?>;acessoAjax('inc/empreiteiras/liberar_lista.ajax.php','frmLiberarDecc','divlistadecc');alert('Cadastro ativado')">
			</td>
		</tr>
		<?php
			}//fim while
