...
<table border="0" cellspacing="0" cellpadding="0" >
  <tr>
    ...
    <td width="650" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Empreiteiras - Liberar </td>  
    <td width="19" align="right" valign="top" background="img/form/cabecalho_fundo.jpg"><a href=""><img src="img/form/cabecalho_btfechar.jpg" width="19" height="21" border="0" /></a></td>
  </tr>
  <tr>
    <td width="18" background="img/form/lateralesq.jpg"></td>
    <td align="center">
		<form method="post" id="frmLiberarDecc" onsubmit="return false">
				...
				<table width="100%">
					...
					<tr>
						<td align="left" colspan="2">
							...
							onclick="acessoAjax('inc/empreiteiras/liberar_lista.ajax.php','frmLiberarDecc','divlistadecc')" />
						</td>
					</tr>
				</table>
			</fieldset>
			<div id="divlistadecc"></div>
		</form>
	</td>
