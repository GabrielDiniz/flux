...
<script language="javascript">
	function docContas(coddoc){
		document.getElementById('hdCodDoc').value = coddoc;
		cancelaAction('frmOperadoras','inc/declaracoes/doc/imprimir_contas_declaracao.php','_blank');
	}
</script>
<table border="0" cellspacing="0" cellpadding="0" class="form">
  <tr>
    <td width="18" align="left" background="img/form/cabecalho_fundo.jpg"><img src="img/form/cabecalho_icone.jpg" /></td>
    <td width="650" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Declra&ccedil;&otilde;es de Operadoras de cr&eacute;dito<br /></td>  
    <td width="19" align="right" valign="top" background="img/form/cabecalho_fundo.jpg"><a href=""><img src="img/form/cabecalho_btfechar.jpg" width="19" height="21" border="0" /></a></td>
  </tr>
  <tr>
    <td width="18" background="img/form/lateralesq.jpg"></td>
    <td align="center">
        <form name="frmDecc" id="frmOperadoras" method="post" onsubmit="return false">
                ...
                <table width="100%">
                    ...
                    <tr>
                    	<td align="left" colspan="2">
                            ...
                            onclick="acessoAjax('inc/operadorascreditos/declarar_pesquisa.ajax.php','frmOperadoras','divDeclaracoesOperadoras')" />
                            &nbsp;
                            <input name="btLimpar" type="reset" class="botao" value="Limpar" />
                        </td>
                    </tr>
                </table>
                <div id="divDeclaracoesOperadoras"></div>
            </fieldset>
        </form>
	</td>
