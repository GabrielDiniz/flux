...
for($i=0; $i<$cont; $i++){
	if($_POST["ckISS".$i]){
		...
		mysql_query("INSERT INTO guias_declaracoes SET codguia='$codguia', codrelacionamento='$coddeclaracao[1]', relacionamento='doc_des'");
		mysql_query("UPDATE doc_des SET estado='B' WHERE codigo='$coddeclaracao[1]'");
	}
}
