...
<tr>
	...
	<td width="700" background="img/form/cabecalho_fundo.jpg" align="left" class="formCabecalho">&nbsp;Relat&oacute;rios - Contadores </td>
...
<tr>
    ...
    <td align="center">
		<form id="frmBoleto" name="frmBoleto" method="post" target="_blank" action="inc/relatorios/imprimirContadores.php">
		<fieldset>
		<legend>
		...
		<table align="left" width="100%">
			<tr>
				...
				<td>
					<label><input type="radio" name="rdbContador" value="A" checked >Ativos </label>&nbsp;
					<label><input type="radio" name="rdbContador" value="I" >Inativos</label>
                    <label><input type="radio" name="rdbContador" value="NL" >N&atilde;o Liberados</label>
			  	</td>
			</tr>
       	</table>
    	</fieldset>
