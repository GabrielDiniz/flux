...
SELECT
  ...
  reclamacoes.estado, reclamacoes.dataatendimento,cadastro.email ,reclamacoes.descricao
FROM
...
list($codigo, $assunto, $especificacao, $tomador_cnpj, $tomador_email, $rps_numero, $rps_data, $rps_valor, $empresa_nome, $empresa_cnpjcpf, $datareclamacao, $estado, $dataatendimento,$prest_email,$descricao) = mysql_fetch_array($sql);
...
<table width="95%" border="0" cellspacing="0" cellpadding="2" align="center">
  ...
  <tr>
  	...
  	<td align="left"><strong><?php print $descricao; ?></strong></td>
  	</tr>
</table>
...
<table width=95% border=0 cellspacing=0 cellpadding=2>
  ...
  <tr>
	...
	if($erro){
		Mensagem("Ocorreu um erro no envio do e-mail!");
	}else{
