...
<form name="frmResultadoPesquisa" id="frmResultadoPesquisa" method="post">
  ...
  ?>
    <tr bgcolor="#FFFFFF">
      ...
      <td align="center"><a style="cursor:pointer" onclick="document.getElementById('btEditar').value='R';document.getElementById('CODIGOresult').value='<?php echo $codigo;?>';document.getElementById('frmResultadoPesquisa').submit();" ><input type="button" class="botao" value="Editar" /></a></td>
    </tr>
	<?php
	} // fecha while
	?>
