...
<?php
	...
	$sql_multa = mysql_query("SELECT codigo, dias, juro , estado FROM juros WHERE codigo = '$codigo'");
	list($codigo,$dias,$juros,$estado) = mysql_fetch_array($sql_multa);
?>
...
<table width="100%">
	<tr bgcolor="#FFFFFF">
		...
		<td width="32%" align="center">
			<input name="txtMultaEdit" id="txtMultaEdit" type="text" class="texto" value="<?php echo $juros;?>" size="16" maxlength="10" style="text-align:center" 
