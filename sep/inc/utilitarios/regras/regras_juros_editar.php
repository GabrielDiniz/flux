...
<?php
	...
	$juro      = $_POST['txtMultaEdit'];
	$estado     = $_POST['cmbEstadoEdit'];
	$cod_update = $_POST['hdCodMultaAtualizar'];
	
	mysql_query("UPDATE juros SET dias = '$tolerancia', juro = '$juro', estado = '$estado' WHERE codigo = '$cod_update'");
	Mensagem_onload("Regra de juros atualizada!");
?>