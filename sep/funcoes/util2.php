...
function imprimirGuia($codguia,$pasta=NULL,$mesmajanela=NULL){
	...
	if($mesmajanela==true){
		if($result->tipo =="R"){
			...
			echo "<script>window.location = ('/../boleto/recebimento/index.php?COD=$codguia')</script>";	
		}else{
			echo "<script>window.location = ('/../boleto/pagamento/$boleto?COD=$codguia')</script>";
		}
		exit;
	}else{
		if($result->tipo =="R"){
			echo "<script>window.open('/../boleto/recebimento/index.php?COD=$codguia')</script>";	
		}else{
			echo "<script>window.open('/../boleto/pagamento/$boleto?COD=$codguia')</script>";
		}
	}
}
