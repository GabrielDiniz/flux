...
<?php 
	...
	if($_GET['COD']){
		...
		$sql=mysql_query("SELECT dop_des.codigo,
						  ...
						  INNER JOIN
						  		 dop_des
						  ON
						  		 dop_des.codorgaopublico=cadastro.codigo
						  WHERE 
						  		  dop_des.codigo='$COD'") or die(mysql_error());;
...
<table width="800" border="0" cellspacing="0" cellpadding="5" align="center">
  <tr>
	...
	<table border="0" cellspacing="0" cellpadding="5" style="border: 0px;">
      <tr>
		...
		Comprovante de Declara&ccedil;&atilde;o Org&atilde;o P&uacute;blico </font></td>
      </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td align="center"><font class="prefeitura"><?php echo $dataemissao; ?></font></td>
  ...
  <tr>
    <td height="200" colspan="4" align="center" valign="middle"><span class="style1">A Prefeitura Municipal de <font class="prefeitura"><?php echo $CONF_CIDADE; ?></font> certifica que o Org&atilde;o P&uacute;blico citado acima concluiu o processo de Declara&ccedil;&atilde;o de Org&atilde;o P&uacute;blico, referente ao per&iacute;odo <font class="prefeitura"><?php echo DataPt($competencia); ?></font>.</span>   </td>
  </tr>
  <tr>
