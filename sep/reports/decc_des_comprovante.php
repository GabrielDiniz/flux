...
<?php 
	...
	if($_GET['COD']){
		...
		$sql=mysql_query("SELECT decc_des.codigo,
  ...
  <tr>
	...
	<table border="0" cellspacing="0" cellpadding="5" style="border: 0px;">
      <tr>
		...
		Comprovante de Declara&ccedil;&atilde;o Empresa de Construção Civil </font></td>
      </tr>
    </table></td>
  </tr>
  <tr>
