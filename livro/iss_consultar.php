...
?>
<br />
 <form method="post" id="frmLivro"  target="_blank">
        ...
        <tr>
            <td height="60" colspan="3" >        
                <?php
                 ...
                 ?>
                        <div id="DivAbas"></div>                           
                        <input type="hidden"  name="txtCodigoPrestador" value="<?php echo $empcnpj->codigo; ?>"/>
                        <table align="left">					
                            <tr>
...
<script type="text/javascript">
	function btnBuscar_click() {
		acessoAjax('../livro/nfe_consultar.ajax.php','frmLivro','dvResultdoLivro');		
	}
</script>