...
if(!(isset($_POST["cmbEmissor"]))) {   
	...
	$_SESSION['codempresa'] = $_POST['cmbEmissor'];
		...
		<br />
			...
			<table width="100%" class="cab06">
				...
				<tr>
					...
					<td>R$ <?php echo DecToMoeda($credito); ?></td>
				</tr>
				<tr>
					<td>Valor Total:</td>
				...
				<tr>
					<td colspan="20" align="left">
						<form action="importar_inserir.php" method="post">
							...
							<input type="hidden" name="hdCodEmpresa" value="<?php echo $_POST['cmbEmissor']; ?>" />
