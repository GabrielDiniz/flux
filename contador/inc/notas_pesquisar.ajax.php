				...
				<table width="100%" border="0" cellspacing="2" cellpadding="2">
					...
					<tr>
						...
						?>
							...
							onclick="VisualizarNovaLinha('<?php echo $codigo;?>','<?php echo"tdnfecont".$x;?>',this,'inc/notas_motivo_cancelar.php')" title="Cancelar nota"/>
						<?php 
						}
						?>
					</td>
					...
					<tr>
						<td colspan="7" id="<?php echo"tdnfecont".$x; ?>" height="1" bgcolor="#999999"></td>
					</tr>
					<?php	$x++;
						} // fim while 
					}else{
